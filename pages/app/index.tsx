  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-1 flex flex-row bg-background p-2 gap-2">
        ...
        <div className=" flex flex-col flex-1 border-solid border-2 border-white	 rounded-md ">
          ...
          <div className="flex flex-row gap-6 h-[200px] px-20 py-5 gap-x-12 justify-center">
            <div
              className="flex flex-col w-[30%] border-solid  border-2 border-white rounded-md hover:bg-white justify-center align-center hover:bg-white"
              onClick={() => router.push("/deploy-nexus")}
            >
              <h1 className="text-center">Deploy Nexus</h1>
            </div>
            <div
              className="flex flex-col w-[30%] border-solid border-2 border-white rounded-md justify-center align-center hover:bg-white"
